...
public class OverState extends State {
	...
	public OverState(Handler handler) {
		...
		uiManager.addObjects(new UIImageButton(56, 223+(64+16), 100, 50, Images.butstart, () -> {
		...
		uiManager.addObjects(new UIImageButton(56, (223+(64+16))+(64+16), 128, 78, Images.BTitle, () -> {
			handler.getMouseManager().setUimanager(null);
			State.setState(handler.getGame().menuState);
		}));
